...
\begin{proof}
  ...
  For the technical criterion of \Cref{thm:existence} pick $u_0 = [1,1] \in H_+^2$ and consider $R=1+\epsilon$, $\epsilon>0$. Then we wish to show that there exists $\epsilon$ such that
  \begin{equation}
    \begin{split}
