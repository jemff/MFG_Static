...
\end{align}
We need to verify that $-U_c^{mon}$ and $-U_p^{mon}$ are strictly pseudoconvex for uniqueness of the Nash equilibrium, as well as show existence of the equilibrium. To this end, we state another characterization of strict pseudomonotonicity for differentiable functions.
\begin{lemma}
  \label{lem:strict_pm}
...
Another small lemma we need is a reduction for pseudomonotone functions from $P_{2,\mu}$.
\begin{lemma}
