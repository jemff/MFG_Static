...
\begin{proof}
  ...
  To show that there exists a solution, start by noting that for all $S\in H^2$, $w\mapsto dU(S)$ is continuous, hence continuous on finite-dimensional subspaces, fulfilling the first part of \Cref{thm:existence}. For the second part, consider
  \begin{equation}
    \label{eq:du}
