...
\begin{proof}
  ...
  \end{split}
  \end{equation}
  To avoid clutter, we neglect the calculations and relegate them to the appendix. In the end, the inner product equals
  \begin{equation}
    \norm{\sigma_c}_2^2 + \norm{\sigma_p}_2^2 - \norm{\sigma_c}_1 - \norm_{\sigma_p}_1 - G_1(\sigma_c,\sigma_p) - G_2(\sigma_c,\sigma_p)
  \end{equation}
  where $G_1,G_2$ are uniformly bounded. This expression clearly tends to infinity as $\norm{(\sigma_c,\sigma_p)}_2$ tends to infinity, with the constraint that $\norm{\sigma_c}_1 = 1, \norm{\sigma_p} = 1$. Hence \Cref{eq:du} is only negative on a bounded subset of $K$, showing existence of a solution to the variational inequality by \Cref{thm:existence}.
